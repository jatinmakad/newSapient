  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      if (formikRef.current) {
        ...
        formikRef.current.setFieldValue("lrGrOther", updated[0].lrGrOther);
        formikRef.current.setFieldValue(
          "vehicleNumber",
          updated[0].vehicleNumber
        );
        formikRef.current.setFieldValue("itemDamage", updated[0].itemDamage);
        formikRef.current.setFieldValue(
          "executingBranchLocation",
          updated[0].executingBranchLocation
        );
        formikRef.current.setFieldValue("insurer", updated[0].insurer);
        formikRef.current.setFieldValue("insurerCity", updated[0].insurerCity);
        formikRef.current.setFieldValue("remarks", updated[0].remarks);
        formikRef.current.setFieldValue(
          "brokerReferenceNumber",
          updated[0].brokerReferenceNumber
        );
      }
    }
                ...
                <Grid lg={12} md={12} sm={12} xs={12} container spacing={2}>
                  ...
                  <Grid lg={4} md={6} sm={12} xs={12} item>
                    <FomikTextField
                      ...
                      name="natureOfLoss"
                      error={
                        touched.natureOfLoss && Boolean(errors.natureOfLoss)
                      }
                      helperText={
                        touched.natureOfLoss ? errors.natureOfLoss : ""
                      }
                    />
                  </Grid>
                  <Grid lg={4} md={6} sm={12} xs={12} item>
